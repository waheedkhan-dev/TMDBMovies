...
class RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideStartUpRepository(movieDao: MovieDao,tmdbApi: TMDBApi,movieDetailDao: MovieDetailDao) : StartUpRepository{
        return StartUpRepository(movieDao = movieDao,tmdbApi = tmdbApi, movieDetailDao = movieDetailDao)
    }
}